...
const INTERFACE_NUMBER_FIELDS = {
  sharedOpacity: { min: 65, max: 100, fallback: 88 },
...
function applyInterfaceTheme(colors = DEFAULT_INTERFACE_COLORS) {
  ...
  root.style.setProperty('--sidebar-effective-backdrop-blur', `${backdropBlur}px`)
      ...
      <div className="button-color-editor-layout interface-color-editor-layout">
        <div className="button-color-sections">
          <details className="card button-color-section sidebar-overlay-controls" open>
            <summary>
              <span><b>Sidebar and Button Transparency</b><small>This controls the transparency of both the sidebar background and all sidebar navigation buttons. Text remains fully opaque.</small></span>
            ...
            <div className="sidebar-overlay-control-grid is-single">
              <label className="sidebar-overlay-control">
                ...
                <input type="range" min="65" max="100" step="1" value={normalizedPreview.sidebar.sharedOpacity} onChange={(event) => onChange('sidebar', 'sharedOpacity', Number(event.target.value))} />
                <input type="number" min="65" max="100" step="1" value={normalizedPreview.sidebar.sharedOpacity} onChange={(event) => onChange('sidebar', 'sharedOpacity', Number(event.target.value))} aria-label="Sidebar and Button Transparency percentage" />
                <small>This single percentage is applied equally to the panel, inactive, hover, active, and utility backgrounds.</small>
              </label>
            </div>
          </details>
